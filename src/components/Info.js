    ...
    <div className="info">
      ...
      <div>
        <p className="infop">
          ...
          multiplier. Hiring the wrong candidate can waste critical time and
          money.
          <br />
          <br />
          Our process has helped build some of the most successful teams.
          <br />
          <br />
          Before we initiate a search, we take a 360 approach to understanding
      ...
      <div>
        <p className="infop">
          ...
          <br />
          <br />
          We believe focus and dedication are central to providing the most
          effective Client Service.
          <br />
          <br />
          At New Talent Group we actively limit the number of Clients we support
