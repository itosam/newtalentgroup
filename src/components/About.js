        ...
        <div className="founder_aboutk">
          ...
          <div className="founder_info">
            ...
            <p>
              ...
              Quadrant. Katie has helped many companies grow to the next level
              by introducing the right talent at the right time. She also
              previously founded and successfully sold Hey Hero, a Creator
              monetization platform, acquired by Sanctuary Ventures. She is a
              proud alumna of Columbia Business School and Tufts University.
            </p>
          </div>
        </div>
        <div className="founder_aboutc">
          ...
          <div>
            ...
            <p className="founder_info">
              ...
              hand the needs of a growing organization, and has hired hundreds
              of employees across the businesses he has built. Cole is an active
